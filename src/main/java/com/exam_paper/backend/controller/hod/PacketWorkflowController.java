...
public class PacketWorkflowController {
    ...
    public ResponseEntity<List<DepartmentPacketResponseDto>> getDepartmentPackets(@PathVariable String deptId) {
    ...
    public ResponseEntity<List<DepartmentPacketResponseDto>> searchDepartmentPackets(
